...
public class MaterialIntImpl implements MaterialInt {
    ...
    public PageResult findPage(PageRequest pageRequest) {
        ...
        ColumnFilter columnFilter3 = pageRequest.getColumnFilter("rkType");
        ColumnFilter columnFilter4 = pageRequest.getColumnFilter("com");
        ColumnFilter columnFilter5 = pageRequest.getColumnFilter("qianTime");
        ColumnFilter columnFilter6 = pageRequest.getColumnFilter("houTime");
        if(columnFilter != null && columnFilter1 !=null && columnFilter2 !=null && columnFilter3 !=null && columnFilter4 !=null && columnFilter5 !=null && columnFilter6 !=null) {
            return MybatisPageHelper.findPage(pageRequest, materialIntMapper, "findPageByNameAndMName", columnFilter.getValue(),columnFilter1.getValue(),
                    columnFilter2.getValue(),columnFilter3.getValue(),columnFilter4.getValue(),columnFilter5.getValue(),columnFilter6.getValue());
        }
